...
/**
 * Add module exports
 * @ref https://github.com/babel/babel/issues/2212
 */
Object.defineProperty(exports, '__esModule', {value: true})

exports.default = bundlerTransform
exports.asunder = bundlerTransform
...
function preparingRequerimentFile (chunk, encoding, opts) {
  ...
  return (cb) => {
    if (preparingRequerimentFile.filesRunned.has(filePath) === false) {
      ...
      for (let his of chunk.history) {
        newHistory.push(path.resolve(path.dirname(his) + '/' + path.basename(his, '.js') + '.' + requerimentfilename))
      ...
      b.bundle((err, _bf) => {
        ...
        logRequeriments(`Se ha preparado en nuevo archivo de requerimientos ${newHistory}`)
